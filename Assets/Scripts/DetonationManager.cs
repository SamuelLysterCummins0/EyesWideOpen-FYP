...
public class DetonationManager : MonoBehaviour
{
    ...
    public void StartDetonationSequence()
    {
        ...
        // Replace the code-number HUD with the escape objective message
        FindObjectOfType<CodeNumberHUD>(true)?.ShowDetonationMessage();
    ...
    private void ResetSequence()
    {
        ...
        // Restore the code-number HUD
        FindObjectOfType<CodeNumberHUD>(true)?.RestoreCodeDisplay();
